...
<!-- Subagent-Profil. Mechanismus: .devin/agents/<name>.md mit Frontmatter name, description,
...
2. Prüfe jede geänderte Datei gegen die Punkte RV1 bis RV12 aus `framework/core/07-review-rules.md`.
