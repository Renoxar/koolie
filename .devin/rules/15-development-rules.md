...
Langform: `framework/core/04-quality.md`, `framework/core/07-review-rules.md`. Projektspezifische Conventions stehen im Overlay und haben bei Konkretisierungen Vorrang vor allgemeinen Mustern.
