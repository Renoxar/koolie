...
1. Preflight-Check (`checklists/01-preflight.md`) begonnen; Modus M1 benannt; eine vorläufige Kontrollstufe ist durch den Menschen geschätzt (die Analyse liefert einen Vorschlag zur Bestätigung oder Korrektur).
2. Die Aufgabenbeschreibung ist bereinigt (K2 gemäß `framework/core/02-privacy.md` Abschnitt 3.3 und 3.4): Titel, technische Beschreibung, Akzeptanzkriterien – ohne Kommentarverläufe, Anhänge, Personen, Kunden, Adressen oder Kennungen.
...
**Ausgeschlossene Informationen:** K3 gemäß `framework/core/02-privacy.md`; `<EXCLUDED_PATHS>`; Ticket-Kommentare, Anhänge, Screenshots und Kundenkommunikation; Produktionsdaten und Produktionslogs; Werte aus Konfigurations- und Umgebungsdateien.
...
11. Ergebnis im Ausgabeformat erzeugen; Ergebnisbericht gemäß `framework/core/05-working-model.md` Abschnitt 3.6 anhängen.
...
1. Kontrollstufe eigenverantwortlich festlegen (`checklists/01-preflight.md`): Vorschlag bestätigen oder mit Begründung korrigieren; im Zweifel die höhere Stufe wählen.
...
| Aufgabenbeschreibung enthält K2-Bestandteile ohne Freigabe oder K3-Bestandteile | [HALT]; Inhalte nicht wiederholen; Bereinigung nach `framework/core/02-privacy.md` Abschnitt 3.3 anfordern |
