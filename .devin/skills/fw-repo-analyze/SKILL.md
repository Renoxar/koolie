...
**Ausgeschlossene Informationen:** K3 gemäß `framework/core/02-privacy.md`; `<EXCLUDED_PATHS>`; Inhalte von Konfigurationsdateien mit Umgebungswerten (nur Struktur beschreiben, keine Werte zitieren); Dateien, die auf Secret-Muster passen.
