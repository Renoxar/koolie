...
| Zielprodukt | Kein einzelnes. Der Kern ist werkzeugneutral; die Bindung an einen KI-Client leistet ein **Client Pack** (`.koolie/core/clients/`). Verfügbar: `devin-desktop` – Devin Desktop (ehemals Windsurf) mit dem Agenten Devin Local, recherchierter Produktstand 3.8.20 vom 21.08.2026 – und `claude-code`. |
