...
Alle normativen Inhalte liegen werkzeugneutral in `.koolie/core/framework/` (kanonische Langform). Der KI-Client liest die **Laufzeitfassungen**: die Wurzel-Anweisungsdatei, die Regelablage mit den Kurzfassungen, die Skill-Ablage mit den ausführbaren Verfahren, die Berechtigungsdatei, die Hook-Konfiguration und die Agentenprofile. Welche Datei- und Verzeichnisnamen das je Client sind, führt das Laufzeitglossar (Anhang 31.2); im Fließtext nennt der Kern nur die Begriffe.
