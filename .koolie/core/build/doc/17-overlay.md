...
{{EMBED:.koolie/core/templates/rules/21-overlay-TEMPLATE.md.template}}
## 17.5 Begleitdateien

Regeln des Dokumentenverzeichnisses und Ausnahmeregister:

{{EMBED-RAW:.koolie/core/templates/project-overlay/documents/README.md:1}}
{{EMBED-RAW:.koolie/core/templates/project-overlay/exceptions/EXCEPTIONS.md:1}}
Ein vollständig ausgefülltes Beispiel (synthetisch) der Laufzeitfassung zeigt `.koolie/core/examples/example-overlay-runtime.md` (im Repository enthalten).
