...
Fehlender Nutzungsvermerk, rote Gates, unaufgelöste MUSS-Befunde oder fehlende Freigaben blockieren den Merge (E1/E2). Nachträglich entdeckte K3-Inhalte: E3 (`.koolie/core/framework/core/02-privacy.md` Abschnitt 5) und Bereinigung vor jeder weiteren Verarbeitung.

## Ergebnis und Nachweis

Der Merge Request dokumentiert Beschreibung, Vermerk, Befunde, Freigaben und Pipeline-Ergebnisse; er ist damit der zentrale Audit-Nachweis je Änderung (`.koolie/core/framework/core/01-governance.md` Abschnitt 4).
