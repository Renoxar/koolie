...
Führt durch das Onboarding-Programm (`.koolie/core/onboarding/GUIDE.md`) bis zur dokumentierten Freigabe für die selbstständige KI-Nutzung. Maßstab ist souveräne Nutzung: Aufgaben angemessen abgrenzen, Kontext kontrolliert bereitstellen, Ergebnisse belastbar prüfen – nicht möglichst viel delegieren.
...
- [ ] **MUSS** `.koolie/core/onboarding/QUICKSTART.md` gelesen; Übungsrepository (`.koolie/core/onboarding/exercises/`) eingerichtet.

### Module (Reihenfolge gemäß `.koolie/core/onboarding/GUIDE.md`)
...
- [ ] **SOLL** Nachschlagewerk (`.koolie/core/onboarding/REFERENCE.md`) und Feedbackweg (`.koolie/core/governance/FEEDBACK_PROCESS.md`) bekannt.
