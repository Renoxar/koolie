...
Stellt sicher, dass ein neues Projekt das Framework vollständig, unverändert im Core und mit ausgefülltem Overlay übernimmt (`.koolie/core/docs/ADOPTION_GUIDE.md`; Grundsatz: Ein Projektwechsel betrifft nur Ebene 4).
...
- [ ] **MUSS** Basistests des Testkatalogs auf dem Übungsrepository ausgeführt (mindestens die Klassen PI, DS, SC aus `.koolie/core/tests/TEST_CATALOG.md`); Ergebnisse dokumentiert.
- [ ] **MUSS** Onboarding für die ersten Nutzerinnen und Nutzer geplant (`.koolie/core/checklists/09-onboarding.md`); bis zur Freigabe arbeiten alle begleitet.
- [ ] **SOLL** Pilotparameter festgelegt (`.koolie/core/pilot/PILOT_CONCEPT.md`: Referenzbasis, Pilotgruppe, `<PILOT_DURATION>`, Anwendungsfälle, Review-Punkte).
