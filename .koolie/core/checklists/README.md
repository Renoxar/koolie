...
2. Unerfüllte MUSS-Punkte stoppen den jeweiligen Schritt; die Abbruch- und Eskalationskriterien der Liste verweisen auf `.koolie/core/framework/core/10-error-escalation.md`.
...
Checklisten sind versioniert (Metadatentabelle) und folgen dem Framework-Release-Prozess. Verbesserungsvorschläge laufen über `.koolie/core/governance/FEEDBACK_PROCESS.md`.
