...
| ID | Zusage des Frameworks | Quelle | Mechanismus beim Client | Einstufung | Beleg |
|---|---|---|---|---|---|
| S1 | Standardaufgaben liegen als versionierte Skills im Repository | `.koolie/core/framework/core/08-skill-conventions.md` | `<TBD>` | `<TBD>` | `<TBD>` |
...
```text
python .koolie/core/install.py --client <TBD: Kurzname>
