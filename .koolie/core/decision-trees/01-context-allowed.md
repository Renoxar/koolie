...
| Quelle | `.koolie/core/framework/core/02-privacy.md`, `.koolie/core/checklists/02-privacy-context.md` |
...
flowchart TD
    ...
    F -- "ja" --> OK1["VERWENDEN"]
    E -- "K2" --> P{"Datenschutz- und<br/>Vertragsprüfung liegt vor?<br/>(02-privacy 1.3)"}
    P -- "nein" --> X5["NICHT VERWENDEN<br/>(bis dahin nur K0/K1)"]
    P -- "ja" --> G{"Freigabe dokumentiert?<br/>APPROVAL_ROLE, bei Personenbezug<br/>+ DATA_PROTECTION_CONTACT"}
