...
2. **Der Mensch ordnet die Eskalationsstufe zu:**
   - **E0 – selbst entscheiden:** S1, S2 ohne erfolgte Bereitstellung, S4, S7, S10 → klären, Scope anpassen, manuell fortsetzen oder Aufgabe neu zuschneiden.
...
flowchart TD
    ...
    D -- "S1 Unklarheit / S2 ohne Bereitstellung /<br/>S4 Scope / S7 Fehlschlag /<br/>S10 Wiederholung" --> E0["E0: Bearbeiter entscheidet<br/>klären, anpassen, manuell fortsetzen"]
