...
| Quelle | `.koolie/core/framework/core/00-principles.md` (P10), `.koolie/core/governance/PRIORITY_HIERARCHY.md` |

## Textbeschreibung (normativ)

1. **Quelle der Regel:** Stammt die Regel aus Gesetz, Regulierung oder einer verbindlichen Vorgabe der Organisation? → Sie wird nicht in das Framework kopiert, sondern über **Ebene B** (`.koolie/core/framework/org-policies/`, Verweisblatt) eingebunden; der Core setzt sie höchstens operativ um.
