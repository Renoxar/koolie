...
2. Systematische Befunde (dieselbe Auffälligkeit in mehreren der KI-Client-Änderungen) werden als Feedback an den Framework Owner gemeldet (`.koolie/core/governance/FEEDBACK_PROCESS.md`), da sie auf eine Regel- oder Skill-Lücke hindeuten.
3. Sicherheitsrelevante Befunde folgen dem Prozess der Organisation und werden zusätzlich in `.koolie/core/governance/INCIDENT_HANDLING.md` erfasst, wenn sie auf ein Framework-Versagen zurückgehen.
