---
description: Projektspezifische Laufzeitfassung des Project Overlays (Ebene 4). Immer aktiv. Wird vom Projekt aus .koolie/project-overlay/OVERLAY.md gepflegt; darf keine Framework-Regeln lockern.
trigger: always_on
---
...
<!-- AUSFÜLLHINWEIS: Diese Datei ist die kompakte, immer geladene Fassung des Overlays.
     Quelle und Detailfassung: .koolie/project-overlay/OVERLAY.md. Beide Dateien werden gemeinsam
...
- Nur lesbar, nie ändern (`<READ_ONLY_PATHS>`): `<TBD: Liste, zum Beispiel api-contracts/**, db/migrations/**>` – zusätzlich immer: `<ROOT_INSTRUCTION_FILE>`, `<RUNTIME_DIR>/`, `<CORE_DIR>/`, `.koolie/project-overlay/`. Ihr Schreibschutz ist kein Leseverbot: Du liest sie als Anweisungsquelle
