...
**Warum falsch:** Die Begründung ist im Repository nicht belegt und damit erfunden (M5 „Verbotene Aktionen", P4); Personen- und Umgebungsangaben dürfen nicht ergänzt werden (`.koolie/core/framework/core/02-privacy.md` Abschnitt 2.1; `<ROOT_INSTRUCTION_FILE>` Abschnitt 11); die fachliche Abweichung wurde durch Löschen „aufgelöst", obwohl unklar ist, welche Seite richtig ist (P3); die Änderung am Quellkommentar liegt außerhalb `<DOC_PATHS>` und ist in M5 verboten.
