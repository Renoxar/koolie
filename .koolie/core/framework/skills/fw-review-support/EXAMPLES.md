...
- Befunde 1 und 2 an den Fundstellen prüfen; <TEST_COMMAND> selbst ausführen (Stufe mittel); Review nach .koolie/core/checklists/04-review-ai-code.md; Entscheidung und Kommentare im Review-Werkzeug durch den Menschen
```
