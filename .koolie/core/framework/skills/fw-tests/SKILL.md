...
1. Preflight-Check (`.koolie/core/checklists/01-preflight.md`) ist durchgeführt; Kontrollstufe mit auslösendem Faktor und Modus M4 sind benannt.
...
4. Freigabevoraussetzungen je Kontrollstufe (wörtlich aus `.koolie/core/framework/core/09-risk-model.md` Abschnitt 3); bei Stufe hoch MUSS die dokumentierte Freigabe vor dem ersten Schreibzugriff referenziert werden, sonst liefert der Skill nur die lesende Testlückenanalyse:
