...
- [ ] Laufzeitfassungen betroffen (Wurzel-Anweisungsdatei, Regelablage, Berechtigungsdatei)? Synchronisierung in **allen** Client Packs geplant (`.koolie/core/clients/README.md`)?
