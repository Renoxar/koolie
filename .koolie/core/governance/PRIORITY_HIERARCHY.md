...
| 2 | Organisationsweite Richtlinien | `.koolie/core/framework/org-policies/` (Einbindungspunkt) |
| 3 | Framework Core | Wurzel-Anweisungsdatei, `.koolie/core/framework/core/`, Regelablage `00-*, 10-*, 15-*`, Berechtigungsdatei (Kernregeln) |
| 4 | Project Overlay | `.koolie/project-overlay/`, Regelablage `20-*`, `2N-*` |
| 5 | Technology Packs | `.koolie/core/framework/tech-packs/`, Regelablage `40-*` |
| 6 | Role Packs | `.koolie/core/framework/role-packs/`, Regelablage `30-*` |
