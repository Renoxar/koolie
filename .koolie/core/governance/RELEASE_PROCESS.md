...
| 4 | **Annotierte, signierte Marke** auf dem Release-Commit: `v` und der Inhalt von `VERSION`, die Nachricht nennt Release, Antrag und die Entscheidungen | 🔴 **der Framework Owner, nicht ein Werkzeug** | **nach** dem Commit |
