...
| Datum | 2026-09-10 |
| Betroffene Artefakte | neu: `leitwerk-core/clients/`; geändert: `leitwerk-core/docs/PLACEHOLDER_REGISTRY.md`, `leitwerk-core/OWNERS.md`, `README.md`, `leitwerk-core/CHANGELOG.md` |
...
Einführung von **Client Packs** unter `leitwerk-core/clients/`:
