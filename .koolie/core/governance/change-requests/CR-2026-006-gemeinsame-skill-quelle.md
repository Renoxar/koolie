...
| Datum | 2026-09-10 |
| Betroffene Artefakte | neu: `leitwerk-core/framework/skills/`; entfernt: `clients/*/root-template/**/skills/`; geändert: `install.py`, `tests/scripts/validate-framework.py`, `clients/*/manifest.json`, `docs/PLACEHOLDER_REGISTRY.md` |
...
**Die Skills liegen einmal** unter `leitwerk-core/framework/skills/` (48 Dateien) und werden bei der Installation in die Form des gewählten Clients gebracht.
