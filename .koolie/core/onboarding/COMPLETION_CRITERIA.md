...
Bei erfüllten Pflichtkriterien dokumentiert die Mentorin oder der Mentor die **Freigabe zur selbstständigen Nutzung** (Datum, Rolle) im Onboarding-Protokoll (`.koolie/core/checklists/09-onboarding.md`, Abschnitt Abschluss). Nicht erfüllte Pflichtkriterien führen zu gezielter Wiederholung der betroffenen Module – begleitetes Arbeiten bleibt bis dahin bestehen. Ein Folgetermin nach den ersten selbstständigen Wochen SOLL vereinbart werden.
