...
- Bestätigter Plan nach `.koolie/core/templates/PLAN_TEMPLATE.md` oder bestätigte Schrittfolge mit Bestätigungsvermerk (Rolle, Datum, Referenz) (K1).
...
Betriebsmodus: M3 Controlled Modification (.koolie/core/framework/core/05-working-model.md). Schreib- und Ausführungsanfragen bestätige ich einzeln; du arbeitest ausschließlich auf Basis des bestätigten Plans.
...
- [ ] `.koolie/core/checklists/03-before-code-change.md` vor dem ersten Schritt abgearbeitet; Plan bestätigt, bei Stufe hoch Freigabe und Pairing dokumentiert.
