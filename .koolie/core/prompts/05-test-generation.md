...
- K3 gemäß `.koolie/core/framework/core/02-privacy.md`; `<EXCLUDED_PATHS>`; Produktionsdaten, Datenbankauszüge, Logs und Fixtures mit Echtdaten – auch nicht als Vorlage für Testdaten (V5).
...
Betriebsmodus: M4 Test and Validation (.koolie/core/framework/core/05-working-model.md). Schreibzugriffe nur in <TEST_PATHS>; einziger Befehl: <TEST_COMMAND>. Schreib- und Ausführungsanfragen bestätige ich einzeln.
