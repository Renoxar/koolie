...
- Bestätigter Plan nach `.koolie/core/templates/PLAN_TEMPLATE.md` ab Stufe mittel; Freigabereferenz bei Stufe hoch (K1).
...
- Gemeldete, nicht geänderte Befunde mit Fundstelle und empfohlenem Folge-Skill; Commit-Vorschläge je Schritt nach `<COMMIT_CONVENTION>`; Annahmen und offene Fragen; Ergebnisbericht nach `.koolie/core/framework/core/05-working-model.md` Abschnitt 3.6.
