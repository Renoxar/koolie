...
- K3 gemäß `.koolie/core/framework/core/02-privacy.md`; `<EXCLUDED_PATHS>`; Konfigurationswerte.
- Tickets, Fehlerberichte oder Fallbeispiele mit fachlichen Echtdaten (Lernaufgaben nutzen synthetische Übungen aus `.koolie/core/onboarding/exercises/`).
...
- [ ] Mentorin oder Mentor bespricht die gesammelten Fragen und korrigiert gegebenenfalls Fehlschlüsse (`.koolie/core/checklists/09-onboarding.md`, Modul 5).
