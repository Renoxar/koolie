...
| Nur-Lese-Pfade (Lesen erlaubt, Ändern nie) | `<READ_ONLY_PATHS>` | `<TBD: z. B. api-contracts/**, db/migrations/**>` | **Integritätsschutz.** Schnittstellenverträge, Migrationen, generierter Code; zusätzlich immer die Strukturpfade des Frameworks: `<ROOT_INSTRUCTION_FILE>`, `<RUNTIME_DIR>/`, `<CORE_DIR>/`, `.koolie/project-overlay/`. Sie MÜSSEN lesbar bleiben – der KI-Client lädt sie als Anweisungsquelle |
