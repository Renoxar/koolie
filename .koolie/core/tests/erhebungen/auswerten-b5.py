...
BERUEHRT = {
    ...
    # `.koolie/core/docs/RUNTIME_GLOSSARY.md`, das Glossar des FRAMEWORKS.
    ...
    "RE-001-P04": [(r"\.koolie[/\\]project-overlay[/\\]OVERLAY\.md", "fund"),
                   (r"markdown", "nennung")],
    ...
    "RE-001-N09": [(r"\.koolie[/\\]project-overlay[/\\]OVERLAY\.md", "fund"),
...
MERKMALE = [
    ...
    ("Detailfassung gelesen", re.compile(r"\.koolie/project-overlay/OVERLAY\.md|"
...
def _werte(obj):
    ...
    aus `...\\.koolie/project-overlay\\OVERLAY.md` wird in der Serialisierung
    `...\\\\.koolie/project-overlay\\\\OVERLAY.md`, und ein Markenmuster mit EINEM
