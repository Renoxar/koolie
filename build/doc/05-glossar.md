...
| Framework Core | Ebene 3 der Prioritätshierarchie; projektunabhängige Module FW-CORE-00…10 unter `framework/core/` |
...
| Devin-Nutzungsvermerk | Kennzeichnungsblock in Merge Requests (`templates/MR_AI_DISCLOSURE.md`) |
...
| Decision Log | fortgeschriebenes Entscheidungs- und Klärungsregister (`governance/DECISION_LOG.md`) |
