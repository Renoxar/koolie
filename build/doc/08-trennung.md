...
| Getrennte Ablage und Ownership | Core: Framework Owner über Releases; Overlay: Overlay Owner über den Projektprozess; technische Schreibsperren (`Write(framework/**)`, `Write(.devin/**)`, `Write(AGENTS.md)`, `Write(project-overlay/**)` als `deny` für Devin) |
