...
Paket nicht im Artefakt-Repository, Identität unklar, offene kritische Schwachstellen oder Lizenzfragen ungeklärt → keine Einführung; Klärung über E1/E2, bei Sicherheitsverdacht E3 (`framework/core/10-error-escalation.md`).
