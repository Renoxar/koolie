...
2. Unerfüllte MUSS-Punkte stoppen den jeweiligen Schritt; die Abbruch- und Eskalationskriterien der Liste verweisen auf `framework/core/10-error-escalation.md`.
...
Checklisten sind versioniert (Metadatentabelle) und folgen dem Framework-Release-Prozess. Verbesserungsvorschläge laufen über `governance/FEEDBACK_PROCESS.md`.
