...
| Client Packs (Abbildung auf KI-Clients) | `devin-core-framework/clients/` | `<FRAMEWORK_OWNER>` | `<SECURITY_CONTACT>` für Kernzusagen ohne technische Durchsetzung |
| Client Pack `devin-desktop` (CP-DD) | `devin-core-framework/clients/devin-desktop/` | `<FRAMEWORK_OWNER>` | `<TBD: Rolle>` |
| Client Pack `claude-code` (CP-CC) | `devin-core-framework/clients/claude-code/` | `<FRAMEWORK_OWNER>` | `<TBD: Rolle>` |
