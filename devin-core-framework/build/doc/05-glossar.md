...
| Framework Core | Ebene 3 der Prioritätshierarchie; projektunabhängige Module FW-CORE-00…10 unter `devin-core-framework/framework/core/` |
...
| Devin-Nutzungsvermerk | Kennzeichnungsblock in Merge Requests (`devin-core-framework/templates/MR_AI_DISCLOSURE.md`) |
...
| Decision Log | fortgeschriebenes Entscheidungs- und Klärungsregister (`devin-core-framework/governance/DECISION_LOG.md`) |
