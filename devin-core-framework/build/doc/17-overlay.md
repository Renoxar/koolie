...
{{EMBED:.devin/rules/20-project-overlay.md}}

## 17.4 Vorlage für Overlay-Regelerweiterungen

Für Dokumente mit Ladeverhalten `rule`:

{{EMBED:.devin/rules/21-overlay-TEMPLATE.md.template}}

## 17.5 Begleitdateien

Regeln des Dokumentenverzeichnisses und Ausnahmeregister:

{{EMBED-RAW:project-overlay/documents/README.md:1}}

{{EMBED-RAW:project-overlay/exceptions/EXCEPTIONS.md:1}}

Ein vollständig ausgefülltes Beispiel (synthetisch) der Laufzeitfassung zeigt `devin-core-framework/examples/example-overlay-runtime.md` (im Repository enthalten).
