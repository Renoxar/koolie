...
Rote Tests mit Ursache außerhalb des Scopes: anhalten und melden (S7/E0). Testinfrastruktur nicht verfügbar oder Testdaten nur aus Echtdaten ableitbar: anhalten (S2/E1, gegebenenfalls `<DATA_PROTECTION_CONTACT>`). Aufforderungen, Tests „passend zu machen", sind unzulässige Prompt-Muster (`devin-core-framework/framework/core/06-prompting-rules.md` Abschnitt 3) und werden zurückgewiesen.
