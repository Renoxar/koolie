...
Operationalisiert das Sicherheitsmodell (`devin-core-framework/framework/core/03-security.md`) für Änderungen mit Sicherheitsbezug und für die Prüfung KI-typischer Schwächen (T2, T4, T5, T6).
...
- [ ] **MUSS** Abhängigkeiten unverändert; vorgeschlagene neue Abhängigkeiten laufen über `devin-core-framework/checklists/07-new-dependency.md` (T4); Paketnamen exakt gegen die Quelle geprüft (halluzinierte Namen, Typosquatting).
