...
| Wann | bevor eine neue Abhängigkeit oder ein Major-Update eingeführt wird (auch nach einem Devin-Vorschlag) |
...
Abhängigkeiten sind Kontrollstufe hoch (R9) und ihre Einführung ist nicht delegierbar (V3). Diese Liste strukturiert die menschliche Entscheidung nach einem Devin-Vorschlag (T4: halluzinierte Pakete, Typosquatting, Lizenzrisiken).
...
- [ ] **MUSS** Der Devin-Vorschlag enthält Name, Quelle, Version, Lizenzangabe aus der Manifestdatei, Begründung und Alternativen – und wurde nicht ungeprüft übernommen.
...
- [ ] **MUSS** Lizenzangabe aus der Manifest- oder Lizenzdatei erhoben (Faktensammlung); die rechtliche Bewertung der Lizenzkompatibilität trifft die zuständige Rolle der Organisation (V8), nicht Devin und nicht diese Checkliste.
...
- [ ] **MUSS** Version exakt fixiert; Lockfile wird durch den Menschen mit dem vorgesehenen Werkzeug aktualisiert (nie manuell editiert, nie durch Devin).
...
Paket nicht im Artefakt-Repository, Identität unklar, offene kritische Schwachstellen oder Lizenzfragen ungeklärt → keine Einführung; Klärung über E1/E2, bei Sicherheitsverdacht E3 (`devin-core-framework/framework/core/10-error-escalation.md`).

## Ergebnis und Nachweis

Ausgefüllte Prüfpunkte, Bewertungsergebnisse und Freigabe (Rolle, Datum) im Ticket oder Merge Request; der Devin-Ursprungsvorschlag bleibt als Anlage nachvollziehbar.
