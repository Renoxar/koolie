...
- [ ] **MUSS** Konsistenz Core ↔ Laufzeitfassung geprüft: `devin-core-framework/framework/core/*` gegen `AGENTS.md` und `.devin/rules/00-*, 10-*, 15-*` (Stichproben je geändertem Modul; keine widersprüchlichen Anweisungen).
