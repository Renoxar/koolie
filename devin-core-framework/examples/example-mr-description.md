...
> Synthetisches Beispiel nach Skill `fw-mr-description` und `devin-core-framework/templates/MR_AI_DISCLOSURE.md` (Kurzform, Stufe niedrig). Projekt, Ticket und Inhalte sind erfunden.
