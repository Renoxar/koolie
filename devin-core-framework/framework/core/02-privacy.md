...
1. Die Einstufung erfolgt durch den Menschen vor der Bereitstellung (Entscheidungsbaum `devin-core-framework/decision-trees/01-context-allowed.md`).
...
4. Vorfall im Framework-Betrieb erfassen (`devin-core-framework/governance/INCIDENT_HANDLING.md`) und Ursache im nächsten Review-Zyklus adressieren (zum Beispiel fehlende `deny`-Regel).
