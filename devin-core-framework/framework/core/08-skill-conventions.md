...
- Die strukturelle Konformität prüft `devin-core-framework/tests/scripts/validate-framework.py` (Pflichtabschnitte, Frontmatter, Platzhalter, verbotene Muster).
