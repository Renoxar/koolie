...
1. Organisationsweite Vorgaben haben Vorrang vor dem Framework Core (`devin-core-framework/governance/PRIORITY_HIERARCHY.md`). Enthält eine Vorgabe eine strengere Regel, gilt sie unmittelbar; das Framework wird im nächsten Release angepasst, wenn die strengere Regel dauerhaft ist.
...
4. Abgleich: Das Klassifizierungsschema der Organisation wird auf die Kontextklassen K0–K3 abgebildet (`devin-core-framework/framework/core/02-privacy.md`); die Abbildung wird hier dokumentiert: `<TBD: Abbildungstabelle Organisationsklassifizierung → K0–K3>`.
