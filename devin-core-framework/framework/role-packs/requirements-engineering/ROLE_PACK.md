...
Aufgabenbeschreibungen und Ticketinhalte sind in der Regel **K2** (`devin-core-framework/framework/core/02-privacy.md`): Sie werden je Aufgabe freigegeben und bereinigt übergeben. Für dieses Pack gilt zusätzlich:
