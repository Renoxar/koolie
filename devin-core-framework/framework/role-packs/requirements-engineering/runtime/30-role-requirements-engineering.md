...
Quelle und Detailfassung: `devin-core-framework/framework/role-packs/requirements-engineering/ROLE_PACK.md`.
...
(`project-overlay/forbidden-terms.txt`) gilt auch für Entwürfe. Bei einem K3-Fund: nicht
