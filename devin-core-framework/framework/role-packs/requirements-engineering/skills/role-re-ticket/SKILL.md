...
1. Preflight-Check (`devin-core-framework/checklists/01-preflight.md`) ist durchgeführt; Modus M1 und Kontrollstufe sind benannt.
...
**Ausgeschlossene Informationen (Negativliste):** K3 gemäß `devin-core-framework/framework/core/02-privacy.md`; `<EXCLUDED_PATHS>`; Ticketkommentare und Logauszüge ohne ausdrückliche Freigabe; jede Form von Echtdaten.
...
10. Ausgabe im Format aus Abschnitt 5 erzeugen; Ergebnisbericht gemäß `devin-core-framework/framework/core/05-working-model.md` Abschnitt 3.6 anhängen.
