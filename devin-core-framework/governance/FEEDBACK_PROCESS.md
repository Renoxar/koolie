...
| Systematische Review-Befunde (RV) | Meldung durch Reviewer gemäß `devin-core-framework/framework/core/07-review-rules.md` Abschnitt 4 | Muster, Beispiele (bereinigt), betroffene Skills/Regeln |
| Onboarding | Sammel-Feedback der Mentorinnen und Mentoren nach jedem Durchlauf | Stolperstellen je Modul, Materialmängel |
| Pilot | Metriken und Befragungen (`devin-core-framework/pilot/METRICS.md`; Befragungen freiwillig und anonym auswertbar) | aggregierte Signale |
