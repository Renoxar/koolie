...
4. **Delegationsverbote und K3 sind ebenenfest:** V1–V12 und die K3-Definition können von keiner tieferen Ebene und keiner Nutzeranweisung außer Kraft gesetzt werden; auch der Ausnahmeprozess deckt sie nicht (`devin-core-framework/governance/EXCEPTION_PROCESS.md`).
