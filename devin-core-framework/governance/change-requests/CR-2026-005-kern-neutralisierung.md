...
| Datum | 2026-09-10 |
| Betroffene Artefakte | neu: `devin-core-framework/docs/RUNTIME_GLOSSARY.md`; geändert: `framework/core/*`, `framework/role-packs/`, `framework/tech-packs/`, `governance/`, `checklists/`, `onboarding/`, `prompts/`, `examples/`, `decision-trees/`, `docs/`, `tests/TEST_CATALOG.md`, `OWNERS.md`, `README.md`, `tests/scripts/validate-framework.py` |
...
**Ein Glossar legt die Begriffe fest** (`devin-core-framework/docs/RUNTIME_GLOSSARY.md`) und bildet sie auf die Pfade je Client Pack ab. Es ist das Gegenstück zum Platzhalterregister: dort projektspezifische Werte, hier clientspezifische Pfade.
