...
| Datum | 2026-09-10 |
| Betroffene Artefakte | neu: `devin-core-framework/framework/runtime/`, `devin-core-framework/templates/project-overlay/`, `devin-core-framework/templates/rules/`; geändert: `install.py`, `tests/scripts/validate-framework.py`, `clients/*/manifest.json`, `docs/PLACEHOLDER_REGISTRY.md` |
