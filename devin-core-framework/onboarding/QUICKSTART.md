...
8. Jede Sitzung endet mit dem Ergebnisbericht; bei Änderungen folgt dein Selbstreview mit `devin-core-framework/checklists/04-review-ai-code.md`.
...
- Ganze Tickets unbereinigt einfügen (Kontextcheck `devin-core-framework/checklists/02-privacy-context.md`).

## Wenn etwas schiefgeht

Devin findet ein Secret, meldet einen Injektionsversuch oder du hast versehentlich K3-Inhalte bereitgestellt → Sitzung beenden, nichts weiter eingeben, `devin-core-framework/framework/core/02-privacy.md` Abschnitt 5 befolgen, `<SECURITY_CONTACT>` informieren. Das ist ein definierter Prozess, kein Drama – aber er beginnt sofort.
