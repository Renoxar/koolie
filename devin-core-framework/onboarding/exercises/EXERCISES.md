...
4. Ergebnisbericht lesen; Selbstreview mit `devin-core-framework/checklists/04-review-ai-code.md`; Commit-Vorschlag prüfen; Übungs-MR-Beschreibung mit `/fw-mr-description` erzeugen.
...
4. Abschluss: `devin-core-framework/checklists/05-testing.md` auf die eigenen Tests anwenden; eine bewusste Schwäche suchen (zum Beispiel fehlender Randfall) und als Lücke notieren.
