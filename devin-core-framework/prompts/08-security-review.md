...
| Verwandter Skill | keiner (nutzt den Prüfansatz von `fw-review-support`; Befundklassen aus `devin-core-framework/checklists/06-security.md`) |
...
Ausgabeformat: Befundliste nach Schwere geordnet (Tabelle: Klasse, Schwere, Fundstelle, Mechanismus, Empfehlung), danach „Geprüft ohne Befund", „Nicht prüfbar (mit Grund)", „Annahmen und offene Fragen"; abschließend der Ergebnisbericht nach devin-core-framework/framework/core/05-working-model.md Abschnitt 3.6.
Rückfrageregel: Bei Unklarheit fragen, nicht annehmen; insbesondere wenn Diff-Basis oder Systemgrenzen unklar sind.

Prüfe systematisch die Klassen aus devin-core-framework/checklists/06-security.md:
...
- [ ] Bei bestätigten Schwachstellen: Meldeweg der Organisation eingehalten; Erfassung nach `devin-core-framework/governance/INCIDENT_HANDLING.md`, wenn KI-Bezug besteht.
