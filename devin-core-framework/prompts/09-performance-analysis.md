...
Ausgabeformat: Tabelle „Hypothesen" (Nr., Mechanismus, Fundstellen, erwartete Wirkung (Vermutung), Messvorschlag, Risiko einer Änderung), danach „Nicht untersucht (mit Grund)" und „Annahmen und offene Fragen"; abschließend der Ergebnisbericht nach devin-core-framework/framework/core/05-working-model.md Abschnitt 3.6.
...
| Produktions-Monitoring-Auszüge unbereinigt einfügen | K3-Abfluss (Hostnamen, Kennungen) | Beobachtung bereinigt zusammenfassen (`devin-core-framework/checklists/02-privacy-context.md`) |
