...
- K3 gemäß `devin-core-framework/framework/core/02-privacy.md`; `<EXCLUDED_PATHS>`; Konfigurationswerte.
- Tickets, Fehlerberichte oder Fallbeispiele mit fachlichen Echtdaten (Lernaufgaben nutzen synthetische Übungen aus `devin-core-framework/onboarding/exercises/`).
...
- [ ] Mentorin oder Mentor bespricht die gesammelten Fragen und korrigiert gegebenenfalls Fehlschlüsse (`devin-core-framework/checklists/09-onboarding.md`, Modul 5).
...
| Lernstrecke mit echten Tickets oder Falldaten anreichern | K2/K3-Risiko im Lernkontext | Synthetische Übungen aus `devin-core-framework/onboarding/exercises/` |
