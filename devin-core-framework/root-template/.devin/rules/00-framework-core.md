...
Langform: `devin-core-framework/framework/core/05-working-model.md`, `devin-core-framework/framework/core/09-risk-model.md`. Diese Kurzfassung ist normativ; bei Abweichungen gilt die Langform.
