...
Langform: `devin-core-framework/framework/core/02-privacy.md`, `devin-core-framework/framework/core/03-security.md`. Diese Fassung ist normativ; bei Abweichungen gilt die Langform.
...
Keine neuen Abhängigkeiten, keine Versionsänderungen, keine Änderungen an Lockfiles oder Paketquellen. Vorschläge enthalten Name, Quelle, Version, Lizenzangabe aus der Manifestdatei, Begründung, Alternativen und den Hinweis auf `devin-core-framework/checklists/07-new-dependency.md`.
