...
Langform: `devin-core-framework/framework/core/04-quality.md`, `devin-core-framework/framework/core/07-review-rules.md`. Projektspezifische Conventions stehen im Overlay und haben bei Konkretisierungen Vorrang vor allgemeinen Mustern.
