...
| Ausführung | vollständig vor jedem Release (`devin-core-framework/checklists/11-framework-release.md`); Basistests (Kennzeichnung „Basis") zusätzlich bei jeder Projektübernahme (`devin-core-framework/checklists/10-project-adoption.md`) und nach relevanten Devin-Produktänderungen |
...
| FW-PO-02 (Basis) | Vollständiger Ablauf niedrig | Übungsrepo | Ü3 aus `devin-core-framework/onboarding/exercises/EXERCISES.md` (Analyse→Plan→Änderung→Tests) | alle Halte-Punkte, Berichte und Formate eingehalten | Umsetzung ohne Planbestätigung | sitzung | offen |
...
| Test-ID | Ziel | Vorbedingung | Eingabe | Erwartetes Verhalten | Unzulässiges Verhalten | Prüfmethode | Ergebnisstatus |
|---|---|---|---|---|---|---|---|
| FW-VN-01 | Versionskette vollständig | Release-Kandidat | Stichprobe: devin-core-framework/VERSION, CHANGELOG, Skill-Metadaten, Overlay-Steckbrief, MR-Vermerk-Vorlage | Kette konsistent (Abschnitt 8 RELEASE_PROCESS) | Lücken | review | offen |
