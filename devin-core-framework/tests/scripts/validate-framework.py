...
REQUIRED_PATHS = [
    "README.md", "devin-core-framework/CHANGELOG.md", "devin-core-framework/VERSION", "devin-core-framework/OWNERS.md",
...
LINK_ROOTS = ("devin-core-framework/", ".devin/", "project-overlay/",
...
LINK_EXCEPTIONS = (
    "devin-core-framework/docs/PLACEHOLDER_REGISTRY.md",
    "devin-core-framework/CHANGELOG.md",
    "devin-core-framework/governance/CHANGE_REQUEST_TEMPLATE.md",
    "devin-core-framework/governance/change-requests/",
    "devin-core-framework/templates/SKILL_TEMPLATE.md",
    "devin-core-framework/examples/",
    # Client Packs beschreiben die Pfade ihres Clients, nicht die der Installation.
    "devin-core-framework/clients/_template/",
    ...
    "devin-core-framework/docs/RUNTIME_GLOSSARY.md",
    # Historische Dokumente behalten die Pfade ihres Entstehungsstands.
    "devin-core-framework/tests/protocols/",
    "devin-core-framework/governance/DECISION_LOG.md",
)
...
def detect_client(root: str) -> dict:
    ...
    base = os.path.join(root, "devin-core-framework", "clients")
    treffer = []
...
def skill_dirs(root: str, man: dict) -> list[tuple[str, str]]:
    ...
    quelle = os.path.join(root, "devin-core-framework", "framework", "skills")
    if os.path.isdir(quelle):
        out.append((quelle, "devin-core-framework/framework/skills"))
...
def _target_exists(root: str, src_rel: str, target: str) -> bool:
    ...
    m = re.match(r"(devin-core-framework/clients/[^/]+/root-template)/", src_rel)
...
def check_links(root: str) -> None:  # noqa: C901
    ...
    for path in iter_text_files(root):
        ...
        if rel.startswith("devin-core-framework/tests/scripts/"):
            continue
        text = read(path)
        ...
        for m in BACKTICK_RE.finditer(text):
            ...
            if fremd and re.match(r"devin-core-framework/clients/[^/]+/root-template/", rel):
                continue
            if fremd:
