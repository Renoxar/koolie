...
| Platzhalter | Bedeutung | Wird gesetzt in | Beispiel (synthetisch) | Pflicht vor Aktivierung |
|---|---|---|---|---|
| `<FRAMEWORK_OWNER>` | Rolle mit Gesamtverantwortung für das Framework | `OWNERS.md` | „Leitung Entwicklungsmethodik" | ja |
...
| `<PILOT_DURATION>` | Dauer des Piloten | `pilot/PILOT_CONCEPT.md` | „8 Wochen" | vor Pilotstart |
...
| `<JAHR>`, `<JJJJ>`, `<NNN>` | Schema-Platzhalter für Jahres- und Laufnummern in IDs (`CR-<JAHR>-<NNN>`, `INC-<PROJECT_CODE>-<JJJJ>-<NNN>`) | Vorlagen in `governance/` | „CR-2026-001" | – |
