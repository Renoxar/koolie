...
4. Der Prompt-Injection-Testkatalog (`tests/TEST_CATALOG.md`, Klasse PI) wird bei jeder Framework-Änderung und bei jeder relevanten Devin-Produktänderung erneut ausgeführt.
...
2. Vor der Einführung prüft ein Mensch anhand `checklists/07-new-dependency.md`: Existenz im Artefakt-Repository der Organisation, Lizenzkonformität, Pflegezustand, bekannte Schwachstellen, Notwendigkeit.
