...
| Q5 | Kommentare und Commit-Nachrichten beschreiben das Warum, nicht die Tatsache der KI-Nutzung; die KI-Nutzung wird im Merge Request vermerkt (`templates/MR_AI_DISCLOSURE.md`). | SOLL |
...
3. die Review-Checkliste für KI-generierten Code (`checklists/04-review-ai-code.md`) durch die Bearbeiterin oder den Bearbeiter abgearbeitet ist,
...
Für den Pilot werden je Devin-unterstütztem Merge Request erfasst: Kontrollstufe, Betriebsmodus, Anzahl Review-Iterationen, Anzahl fehlgeschlagener Pipeline-Läufe, Anteil verworfener Devin-Vorschläge (Selbsteinschätzung), Nachbearbeitungsaufwand (Selbsteinschätzung in Kategorien). Zielwerte werden nicht durch das Framework vorgegeben (`pilot/METRICS.md`).
