...
Jede Anweisung an Devin, die über eine einfache Rückfrage hinausgeht, SOLL die folgenden Elemente enthalten. Skills und Prompt-Vorlagen (`prompts/`) setzen diese Struktur um:
