...
| E3 | Sicherheits- oder Datenschutzvorfall (S2 mit erfolgter Bereitstellung, S3, S6) | `<SECURITY_CONTACT>`, bei personenbezogenen Daten `<DATA_PROTECTION_CONTACT>` | Prozess der Organisation; Erfassung in `governance/INCIDENT_HANDLING.md` |
