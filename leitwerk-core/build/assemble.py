#!/usr/bin/env python3
"""Assembliert das Hauptdokument aus leitwerk-core/build/doc/*.md und Repository-Artefakten.
...
Ausgabe: leitwerk-core/build/out/hauptdokument.md
"""
...
# CORE = leitwerk-core/ (dieses Skript liegt in CORE/build/).
