...
| **Stand dieses Dokuments** | **Der Fließtext der Kapitel 1 bis 32 steht auf Framework-Release 0.1.0 und ist durchgängig aus der Sicht eines einzelnen KI-Clients geschrieben.** Client Packs, Abbildungsschicht und Fähigkeitsmatrix (Releases 0.5.0 und 0.6.0) sind dort noch nicht eingearbeitet. Maßgeblich ist bis dahin das Repository, nicht dieses Dokument. |
