...
{{EMBED-RAW:leitwerk-core/governance/PRIORITY_HIERARCHY.md:2}}

## 25.2 RACI-Vorlage

{{EMBED-RAW:leitwerk-core/governance/RACI.md:2}}

## 25.3 Review-Zyklus, Versionierung, Release und Produktbeobachtung

{{EMBED-RAW:leitwerk-core/governance/RELEASE_PROCESS.md:2}}

## 25.4 Änderungsanträge

{{EMBED:leitwerk-core/governance/CHANGE_REQUEST_TEMPLATE.md}}

## 25.5 Ausnahmeprozess

{{EMBED-RAW:leitwerk-core/governance/EXCEPTION_PROCESS.md:2}}

## 25.6 Feedbackprozess

{{EMBED-RAW:leitwerk-core/governance/FEEDBACK_PROCESS.md:2}}

## 25.7 Behandlung von Sicherheits- und Datenschutzvorfällen

{{EMBED-RAW:leitwerk-core/governance/INCIDENT_HANDLING.md:2}}

## 25.8 Ownership

{{EMBED-RAW:leitwerk-core/OWNERS.md:2}}
