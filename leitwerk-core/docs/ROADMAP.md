...
| **0.69.0** | 🆕 **Der Prüfapparat bekommt einen Filter.** Der Sondenlauf fährt **233 Einheiten, rund 2400 s Rechenzeit**, und zwar **zweimal je Release** (D-49). Jede Einheit kopiert das ganze Repositorium und fährt **alle** Prüfungen, um **eine** Meldung zu sehen. Drei Hebel: ein Filter `--nur <Nummern>` für die Entwicklungsschleife, ein `--nur-pruefung` im Validator und eine Kopie **je Bahn** statt je Einheit. 🔴 **Der volle Lauf bleibt die Abnahme vor dem Merge** – D-23 bleibt unberührt, gekürzt wird die Schleife davor, nicht der Nachweis | – | nein |
