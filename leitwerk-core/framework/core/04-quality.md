...
Für den Pilot werden je KI-unterstütztem Merge Request erfasst: Kontrollstufe, Betriebsmodus, Anzahl Review-Iterationen, Anzahl fehlgeschlagener Pipeline-Läufe, Anteil verworfener KI-Vorschläge (Selbsteinschätzung), Nachbearbeitungsaufwand (Selbsteinschätzung in Kategorien). Zielwerte werden nicht durch das Framework vorgegeben (`leitwerk-core/pilot/METRICS.md`).
