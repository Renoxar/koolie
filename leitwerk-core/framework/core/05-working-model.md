...
|---|---|---|---|---|
| 1 | Aufgabe verstehen | Mensch, dann Devin | Aufgabenziel, Erfolgskriterium, betroffener Bereich in eigenen Worten wiedergeben | `leitwerk-core/prompts/`, `leitwerk-core/checklists/01-preflight.md` |
...
| 10 | Änderung in kleinen, nachvollziehbaren Schritten umsetzen | Devin unter Beobachtung | Ein logischer Schritt je Änderung; nach jedem Schritt Zwischenstand berichten (P7) | Skill `fw-change-small`, `leitwerk-core/checklists/03-before-code-change.md` |
