...
Aufgabenbeschreibungen und Ticketinhalte sind in der Regel **K2** (`leitwerk-core/framework/core/02-privacy.md`): Sie werden je Aufgabe freigegeben und bereinigt übergeben. Für dieses Pack gilt zusätzlich:
...
4. Die projektlokale Sperrbegriffsliste (`project-overlay/forbidden-terms.txt`) gilt auch für Entwürfe.

## 9. Aktivierung im Projekt

1. Rolle im Overlay Abschnitt 1 („Rollen im Team") aufführen.
2. Laufzeitfassung kopieren:
   `leitwerk-core/framework/role-packs/requirements-engineering/runtime/30-role-requirements-engineering.md`
