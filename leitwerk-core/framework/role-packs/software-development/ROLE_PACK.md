...
Dieses Pack ist nach einer Erstinstallation **nicht** aktiv. Es wird wie jedes Pack im Projekt aktiviert (`leitwerk-core/framework/role-packs/README.md` Punkt 4):
...
3. Validieren: `python leitwerk-core/tests/scripts/validate-framework.py --strict-overlay`
