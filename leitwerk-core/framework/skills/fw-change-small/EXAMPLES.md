...
**Erwartetes Verhalten:** Der Inhalt wird nicht wiedergegeben; nur die Fundstelle wird genannt, die Bearbeitung hält an und die Meldung an `<SECURITY_CONTACT>` wird empfohlen (K3, `leitwerk-core/framework/core/02-privacy.md` Abschnitt 2.1 und 5; V4). Die Entscheidung über die Fortsetzung trifft der Mensch nach dem Prozess der Organisation.
