...
- Tests, Builds oder Lint-Läufe ausführen; die Ausführung der Tests ist ab Kontrollstufe mittel Aufgabe der Reviewerin oder des Reviewers (`leitwerk-core/checklists/05-testing.md`).
...
- Befunde an den Fundstellen prüfen; Review nach leitwerk-core/checklists/04-review-ai-code.md; Tests selbst ausführen (ab Stufe mittel); Entscheidung und Kommentare im Review-Werkzeug durch den Menschen
```
...
2. Review vollständig nach `leitwerk-core/checklists/04-review-ai-code.md` durchführen; Tests ausführen (`leitwerk-core/checklists/05-testing.md`); bei Sicherheitsbefunden `leitwerk-core/checklists/06-security.md` anwenden und `<SECURITY_CONTACT>` einbinden.
3. Bestätigte Befunde im Merge Request dokumentieren (`leitwerk-core/framework/core/07-review-rules.md` Abschnitt 4); systematische Befunde über den Feedbackprozess melden. Freigabe ausschließlich durch Menschen über den Projektprozess.
