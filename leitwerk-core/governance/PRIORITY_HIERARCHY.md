...
4. **Delegationsverbote und K3 sind ebenenfest:** V1–V12 (`leitwerk-core/framework/core/09-risk-model.md`, Abschnitt 4) und die K3-Definition (`leitwerk-core/framework/core/02-privacy.md`, Abschnitt 2.1) können von keiner tieferen Ebene und keiner Nutzeranweisung außer Kraft gesetzt werden; auch der Ausnahmeprozess deckt sie nicht (`leitwerk-core/governance/EXCEPTION_PROCESS.md`), und auch die Einstufungsregeln der Langform selbst dürfen es nicht (D-52). **Ebenenfest heißt nicht unveränderlich:** Geändert werden können beide Listen über den Änderungsprozess des Frameworks – auf ihrer eigenen Ebene, nicht unter ihr.
