...
5. Devin darf: Optionen analysieren (Name, Version, Lizenzangabe, Alternativen) und nach menschlicher Einführung der Bibliothek die Verwendungen gemäß bestätigtem Plan anpassen. Devin darf nicht: die Abhängigkeit einführen, Manifest/Lockfile ändern (V3, R9 → hoch, `leitwerk-core/checklists/07-new-dependency.md`).
