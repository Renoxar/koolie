...
8. Jede Sitzung endet mit dem Ergebnisbericht; bei Änderungen folgt dein Selbstreview mit `leitwerk-core/checklists/04-review-ai-code.md`.
...
`leitwerk-core/onboarding/REFERENCE.md` (Spickzettel) · `GUIDE.md` (Programm) · `leitwerk-core/prompts/README.md` (Vorlagen) · Skill-Ablage (Skills) · Fragen: Mentorin oder Mentor, danach `leitwerk-core/governance/FEEDBACK_PROCESS.md`.
