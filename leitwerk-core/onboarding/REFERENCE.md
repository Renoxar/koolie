...
> Kurzreferenz; maßgeblich sind die Wurzel-Anweisungsdatei und `leitwerk-core/framework/core/`. Version: siehe `leitwerk-core/VERSION`.
...
Prompt-Vorlagen für Fälle ohne Skill: `leitwerk-core/prompts/README.md`.
