...
Ausgabeformat: Tabelle „Hypothesen" (Nr., Mechanismus, Fundstellen, erwartete Wirkung (Vermutung), Messvorschlag, Risiko einer Änderung), danach „Nicht untersucht (mit Grund)" und „Annahmen und offene Fragen"; abschließend der Ergebnisbericht nach leitwerk-core/framework/core/05-working-model.md Abschnitt 3.6.
