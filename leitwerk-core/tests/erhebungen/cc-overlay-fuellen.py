...
Zwei Quellen, beide versioniert:
  ...
  1. `project-overlay/OVERLAY.md`  - die QUELLE. Aus ihren Tabellen (Abschnitt 4
...
try:
    shutil.copytree(os.path.join(CC, "leitwerk-core"), os.path.join(ref, "leitwerk-core"))
    r = subprocess.run([sys.executable, os.path.join(ref, "leitwerk-core", "install.py"),
