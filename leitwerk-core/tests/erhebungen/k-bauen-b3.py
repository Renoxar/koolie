...
BEREICHE = [
    ...
    ".claude/agents",
    ".claude/skills",
    "leitwerk-core/framework",
    "leitwerk-core/checklists",
    "leitwerk-core/decision-trees",
    "leitwerk-core/templates",
    "leitwerk-core/onboarding",
    "leitwerk-core/clients",
    ...
    "leitwerk-core/governance/EXCEPTION_PROCESS.md",
...
AUFZEICHNUNGEN = [
    ...
    "leitwerk-core/tests",
    "leitwerk-core/docs/ROADMAP.md",
    "leitwerk-core/docs/ADOPTION_GUIDE.md",
    "leitwerk-core/build",
    "leitwerk-core/pilot",
    "leitwerk-core/CHANGELOG.md",
    "leitwerk-core/OWNERS.md",
    "docs",
    "tools",
]
