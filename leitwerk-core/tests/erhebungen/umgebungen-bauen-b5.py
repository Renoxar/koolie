...
PFLICHT = [
    ...
    ("Glossar (P01, Manifest-Typ glossary)",
     os.path.join("project-overlay", "documents", "glossary", "biv-glossar.md")),
...
def main():
    ...
    overlay = lies(os.path.join(BAUM, "project-overlay", "OVERLAY.md"))
    ...
    manifest_overlay = lies(os.path.join(BAUM, "project-overlay",
    ...
    pruef = subprocess.run(
        [sys.executable,
         os.path.join(BAUM, "leitwerk-core", "tests", "scripts",
                      "validate-output.py"),
