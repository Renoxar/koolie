...
**E1 und E2 sind wiederholt worden**, weil ihre Hook-Aufzeichnungen beim ersten Durchgang
überschrieben worden waren und ERH-15 auf ihnen beruht. Beide Wiederholungen ergaben Zeichen für
Zeichen dieselben Ausschläge und dieselben Aufzeichnungen – zwei Einträge in E1, drei in E2. Die
Rohausgaben und die getrennten Aufzeichnungen liegen außerhalb des Repositoriums bei den übrigen
Belegen dieser Erhebung.
...
| ERH-15 | **Ein von der Berechtigungsschicht blockierter `Read` erreicht den Hook nicht** – ein blockierter Shell-Aufruf schon. In E1 führt die Aufzeichnung den Lesezugriff auf `.env` **nicht**, den `Bash`-Aufruf dagegen; in E2, wo keine Verweigerungsregel steht, führt sie alle drei Aufrufe. Die zweite Linie sieht also nicht, was die erste bereits abgewiesen hat; **sie ist Ersatz, keine Verdopplung** | Getrennte Aufzeichnungen aus E1 (2 Einträge) und E2 (3 Einträge), beide in der Wiederholung bestätigt |
