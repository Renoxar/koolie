...
Ablage der Ergebnisse aus `leitwerk-core/tests/TEST_CATALOG.md` (Verfahren Punkt 4).
...
| Zusätzlich bei einem Nachweis aus dem **Ausbleiben** einer Wirkung | der Beleg des Laufs selbst – Ausgabe, Aufzeichnung oder Positivkontrolle im selben Lauf – und der Ausweis aufgehobener Schutzvorkehrungen des Clients (Verfahren Punkt 7) |
