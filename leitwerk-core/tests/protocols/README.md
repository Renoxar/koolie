...
Ablage der Ergebnisse aus `leitwerk-core/tests/TEST_CATALOG.md` (Verfahren Punkt 3).
...
| Zusätzlich bei `sitzung` | Version des KI-Clients, Modell (falls wählbar) – Verfahren Punkt 4 |
