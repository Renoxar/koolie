...
> Kurzreferenz; maßgeblich sind `AGENTS.md` und `framework/core/`. Version: siehe `VERSION`.
...
Prompt-Vorlagen für Fälle ohne Skill: `prompts/README.md`.
