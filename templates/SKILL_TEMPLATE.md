...
<!-- ==========================================================================================
     ...
     - Pflichtinhalte 1–23 laut framework/core/08-skill-conventions.md Abschnitt 4.
     ========================================================================================== -->
...
1. Preflight-Check (`checklists/01-preflight.md`) ist durchgeführt; Kontrollstufe und Modus sind benannt.
...
**Ausgeschlossene Informationen (Negativliste):** K3 gemäß `framework/core/02-privacy.md`; `<EXCLUDED_PATHS>`; `<skillspezifische Ausschlüsse, z. B. Produktionslogs, Ticket-Kommentare>`.
...
6. Ergebnisbericht gemäß `framework/core/05-working-model.md` Abschnitt 3.6 anhängen.
